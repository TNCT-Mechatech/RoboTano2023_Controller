...
#define CLOCK_SOURCE                                                          USE_PLL_HSI                                                                                      // set by target:NUCLEO_F303K8
#define LPTICKER_DELAY_TICKS                                                  1                                                                                                // set by target:MCU_STM32
#define MBED                                                                  0                                                                                                // set by application
...
#define MBED_CONF_TARGET_I2C_TIMING_VALUE_ALGO                                0                                                                                                // set by target:MCU_STM32F3
